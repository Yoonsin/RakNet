	...
	InputReceiverEnabled(true), TargetAndRotationAreBound(false)
{
	...
	replicationPos = getAbsolutePosition();
	replicationRot = Target;
}
...
{
	core::vector3df pos = getAbsolutePosition();//replicationPos;
	core::vector3df tgtv = Target - pos; //replicationRot - pos;//Target - pos;
	tgtv.normalize();
