...
namespace scene
{
	...
	public:
		...
		//Before Server Authoritative Version
		void animateNodeOrigin(ISceneNode* node, u32 timeMs);
		...
		core::vector3df replicationPos;
		core::vector3df replicationTarget;
	
		virtual void setReset(bool reset) { 
			isPassAnimateNode = reset;
		}

		bool isPassAnimateNode;
};
